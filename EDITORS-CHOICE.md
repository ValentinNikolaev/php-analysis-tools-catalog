...
|---|---|---|
| [PHPStan](https://github.com/phpstan/phpstan)<br><sub>⭐ 14,066</sub> | PHP applications that need configurable type-safety checks and a broad extension ecosystem | Rule levels, baselines, and framework extensions support both gradual adoption and deep type analysis. |
| [psalm](https://psalm.dev)<br><sub>⭐ 5,879</sub> | Projects needing advanced type modelling, taint analysis, and security checks | An expressive type system and taint engine cover correctness and application-security problems. |
...
| Tool | Recommended for | Why it stands out |
|---|---|---|
| [PHP_CodeSniffer](https://github.com/PHPCSStandards/PHP_CodeSniffer)<br><sub>⭐ 1,544</sub> | Teams enforcing published PHP standards or detailed project-specific coding rules | Its extensible sniff API supports mature community standards and precise custom rules. |
...
| [Rector](https://github.com/rectorphp/rector)<br><sub>⭐ 10,399</sub> | Teams automating PHP upgrades, framework migrations, or repeatable refactoring | AST-based rules turn upgrades and refactoring recipes into reviewable project-wide code changes. |
...
| Tool | Recommended for | Why it stands out |
|---|---|---|
| [Semgrep](https://semgrep.dev)<br><sub>⭐ 16,167</sub> | Security teams writing custom checks for PHP and polyglot repositories | Source-like patterns make custom bug and security checks accessible across multiple languages. |
