...
|---|---|---|
| [PHPStan](https://github.com/phpstan/phpstan)<br><sub>⭐ 14,078</sub> | PHP applications that need configurable type-safety checks and a broad extension ecosystem | Rule levels, baselines, and framework extensions support both gradual adoption and deep type analysis. |
...
| [Laravel Pint](https://laravel.com/docs/pint)<br><sub>⭐ 3,152</sub> | Laravel projects that want a low-configuration, framework-oriented formatter | Laravel-maintained presets deliver practical PHP-CS-Fixer defaults with very little setup. |
...
| Tool | Recommended for | Why it stands out |
|---|---|---|
| [Semgrep](https://semgrep.dev)<br><sub>⭐ 16,324</sub> | Security teams writing custom checks for PHP and polyglot repositories | Source-like patterns make custom bug and security checks accessible across multiple languages. |
